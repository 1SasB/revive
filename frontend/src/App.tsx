...
import { ReactComponent as ReviveLogo } from 'images/revive_logo.svg'
      ...
      <div className="p-4 max-w-2xl mx-auto">
        ...
        {status === AppStatus.Idle ? (
          <div className="mx-auto my-6">
            <h2 className="text-gray-400 text-sm font-medium mb-3  inline-flex items-center gap-2">
              <ChatIcon /> Example questions
            </h2>
          ...
          <>
            {hasSummary ? (
              ...
              <div className="h-36 p-6 bg-white rounded-md shadow flex flex-col justify-start items-center gap-4 mt-6">
                <ReviveLogo className="w-16 h-16" />
