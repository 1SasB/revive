...
INDEX = os.getenv("ES_INDEX", "test_herb")
FILE = os.getenv("FILE", f"{os.path.dirname(__file__)}/output2.json")
...
def main():
    ...
    with open(FILE, "rt") as f:
        for doc in json.loads(f.read()):
            if doc.get("Description of the plant"):
                workplace_docs.append(
                    Document(
                        page_content=doc["Description of the plant"],
